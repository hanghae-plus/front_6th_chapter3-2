...
- [x] 반복 일정이 아이콘과 함께 표시됨
- [x] 반복 패턴 정보가 시각적으로 명확하게 표시됨
- [x] 반복 일정과 일반 일정의 구분이 명확함
- [x] 반복 일정 클릭 시 상세 정보가 정상 표시됨
- [x] 기존 일정 표시 기능이 정상적으로 동작함
- [x] 기존 일정 클릭 이벤트가 반복 일정에서도 정상 동작함
